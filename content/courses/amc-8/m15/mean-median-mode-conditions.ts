...
export default {
  ...
  sections: [
    {
      ...
      keyIdea:
        "A known mean and count give the total sum directly; subtract the known values to find a single missing one.",
    },
    {
      id: "a8-m15-l02-s2",
      ...
      keyIdea:
        "Assume an ordering for the unknown value, solve for it, and then confirm the value actually fits that assumed ordering.",
    },
    {
      id: "a8-m15-l02-s3",
      ...
      keyIdea:
        "Use the most direct condition to solve for an unknown, then verify the result against every other condition stated in the problem.",
    },
  ],
  examples: [
    {
      ...
      title: "Working backward from the mean",
      problem:
        "Five numbers have a mean of 20. Four of them are 15, 18, 22, and 25. Find the fifth number.",
      steps: [
      ...
      answer: "20",
      takeaway:
        "A known mean and count give the required total sum directly; the missing value is whatever completes that sum.",
    },
    {
      id: "a8-m15-l02-ex2",
      title: "Working backward from the median, with a position check",
      problem:
        "A data set consists of $4, 9, 15$, and a fourth value $x$, where $x>9$. If the median of the data set is 11, find $x$.",
      steps: [
      ...
      answer: "13",
      takeaway:
        "Solving for an unknown median value requires assuming an order, solving, and then confirming the result actually fits that order.",
    },
    {
      id: "a8-m15-l02-ex3",
      title: "Combining a mean condition with a mode check",
      problem:
        "A data set has six values: $3, 5, 5, 8, 12$, and $x$. The mean of the data set is 7. Find $x$.",
      steps: [
      ...
      answer: "9",
      takeaway:
        "After solving for an unknown from one condition, check that the result does not conflict with any other feature of the data set.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      ...
      difficulty: 3,
      question:
        "Four numbers have a mean of 15. Three of them are 10, 14, and 20. Find the fourth number.",
      answer: "16",
      hints: [
    ...
    },
    {
      ...
      difficulty: 4,
      question:
        "A data set consists of $2, 6, x, 13$, where $6<x<13$, and has median 9. Find $x$.",
      answer: "12",
      hints: [
    ...
    },
    {
      ...
      difficulty: 5,
      question:
        "A data set consists of $5, 11, 20$, and a fourth value $z$, where $z>11$. If the median of the data set is 13, find $z$.",
      answer: "15",
      hints: [
    ...
    },
    {
      ...
      difficulty: 5,
      question:
        "A data set has six values: $4, 6, 6, 10, 15$, and $w$. The mean of the data set is 8. Find $w$.",
      answer: "7",
      hints: [
    ...
    },
    {
      ...
      difficulty: 3,
      question:
        "A data set of 5 numbers has mean 10. If one of the numbers is increased by 15 and no other number changes, what happens to the new mean?",
      choices: [
        "It increases by 15",
        "It increases by 3",
        "It stays the same",
        "It cannot be determined without knowing the other four numbers",
      ],
      answer: 1,
      hints: [
    ...
    },
    {
      ...
      difficulty: 6,
      question:
        "A data set of five whole numbers, listed in increasing order, is $2, 5, x, y, 17$, with $x<y$. The mean of the data set is 9 and the median is 8. Find $y-x$.",
      answer: "5",
      hints: [
  ...
  nextConnection:
    "The next module turns to sums and products that collapse almost entirely through cancellation — telescoping — starting with how to recognize when a general term can be rewritten as a difference of simpler pieces.",
