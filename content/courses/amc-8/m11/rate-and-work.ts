...
export default {
  slug: "rate-and-work",
  intro:
    "A rate compares a quantity to a unit of something else, most often time — pages per minute, miles per hour, or jobs per day. This lesson turns rates into a single reusable equation, amount equals rate times time, and shows how two separate work rates combine into one when people or machines work together.",
  sections: [
    {
      id: "a8-m11-l02-s1",
      ...
      keyIdea:
        "A rate is amount divided by time; once known, it converts any amount of time directly into a total amount.",
    },
    {
      id: "a8-m11-l02-s2",
      ...
      keyIdea:
        "Convert each worker's time into a fraction-of-the-job-per-hour rate, add the rates, then invert the sum to get the combined time.",
    },
    {
      id: "a8-m11-l02-s3",
      ...
      keyIdea:
        "Amount equals rate times time; solve for whichever quantity a problem leaves missing, and watch for completed-versus-remaining phrasing.",
    },
  ],
  examples: [
    {
      ...
      problem:
        "A printer prints 150 pages in 6 minutes. At that same rate, how many pages does it print in 10 minutes?",
      steps: [
      ...
      answer: "250",
      takeaway:
        "Compute the rate first when it is not given directly, then multiply by the requested time.",
    },
    {
      id: "a8-m11-l02-ex2",
      title: "Combining two work rates",
      problem:
        "Painter A can paint a fence alone in 6 hours. Painter B can paint the same fence alone in 3 hours. Working together at their same individual rates, how many hours will it take them to paint the fence?",
      steps: [
      ...
      answer: "2",
      takeaway:
        "Add individual rates, not individual times, to find a combined work rate.",
    },
    {
      id: "a8-m11-l02-ex3",
      title: "Amount completed versus amount remaining",
      problem:
        "A hose fills a pool at a rate of $\\frac{1}{8}$ of the pool per hour. After the hose runs for 3 hours, what fraction of the pool remains empty?",
      steps: [
      ...
      answer: "5/8",
      takeaway:
        "The amount remaining is the complement of the amount completed: subtract the completed fraction from 1.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      ...
      difficulty: 3,
      question:
        "A factory machine produces 84 toys in 4 hours. At that same rate, how many toys does it produce in 7 hours?",
      answer: "147",
      hints: [
    ...
    },
    {
      ...
      difficulty: 3,
      question:
        "Hose A can fill a tank alone in 10 hours. Hose B can fill the same tank alone in 15 hours. If both hoses run together, how many hours will it take to fill the tank?",
      answer: "6",
      hints: [
    ...
    },
    {
      ...
      difficulty: 4,
      question:
        "Working alone, Mia can mow a lawn in 4 hours, and Noah can mow the same lawn in 6 hours. If they work together at their same individual rates, how many hours will it take them to mow the lawn?",
      answer: "12/5",
      hints: [
    ...
    },
    {
      ...
      difficulty: 4,
      question:
        "A pipe fills a pool at a rate of $\\frac{1}{12}$ of the pool per hour. Working alone at this constant rate, how many hours does it take the pipe to fill $\\frac{3}{4}$ of the pool?",
      answer: "9",
      hints: [
    ...
    },
    {
      ...
      difficulty: 3,
      question:
        "A car travels at a constant rate of 50 miles per hour. Which expression gives the distance, in miles, traveled after $t$ hours?",
    ...
    },
    {
      ...
      difficulty: 5,
      question:
        "Working together, pump A and pump B can drain a tank in 5 hours. Pump A alone can drain the tank in 15 hours. How many hours would it take pump B alone to drain the tank?",
      answer: "15/2",
      hints: [
  ...
  nextConnection:
    "The next module builds equations directly from situations like these — the algebra needed to set up and solve for an unknown rate, time, or amount using systems of equations.",
