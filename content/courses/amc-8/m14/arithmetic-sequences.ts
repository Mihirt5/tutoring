...
export default {
  ...
  intro: "An arithmetic sequence is a list of numbers that changes by the same fixed amount from one term to the next. Two short formulas handle almost every question about such a sequence: one finds any single term directly from its position, and the other finds the sum of many consecutive terms without adding them one at a time.",
  sections: [
    {
      id: "a8-m14-l01-s1",
      ...
      keyIdea: "A sequence is arithmetic exactly when the same fixed amount, the common difference, is added to get from each term to the next.",
    },
    {
      id: "a8-m14-l01-s2",
      ...
      keyIdea: "The $n$th term is $a_n=a_1+(n-1)d$; the exponent-like $(n-1)$ reflects that reaching term $n$ takes $n-1$ steps from the first term.",
    },
    {
      id: "a8-m14-l01-s3",
      ...
      keyIdea: "The sum of $n$ arithmetic terms is $S_n=\\frac{n(a_1+a_n)}{2}$, since pairing the first and last terms (and so on) always gives the same pair sum.",
    },
  ],
  examples: [
    {
      ...
      problem: "The first term of an arithmetic sequence is 7, and the common difference is 4. What is the 15th term?",
      steps: [
      ...
      answer: "63",
      takeaway: "The position formula uses $n-1$ steps of size $d$ from the first term, not $n$ steps.",
    },
    {
      id: "a8-m14-l01-ex2",
      title: "Summing by pairing",
      problem: "Find the sum of the first 20 positive integers: $1+2+3+\\cdots+20$.",
      steps: [
      ...
      answer: "210",
      takeaway: "Pairing terms from the outside in turns a long addition into a single multiplication.",
    },
    {
      id: "a8-m14-l01-ex3",
      title: "Finding a position from a term's value",
      problem: "In an arithmetic sequence, the first term is 5 and the common difference is 3. Which term number equals 50?",
      steps: [
      ...
      answer: "16",
      takeaway: "Solving the position formula for $n$ instead of $a_n$ answers \"which term\" questions.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      id: "a8-m14-l01-q1", role: "guided", kind: "numeric", difficulty: 2,
      question: "The first term of an arithmetic sequence is 12, and the common difference is $-3$. What is the 10th term?",
      answer: "-15",
      hints: [
    ...
    {
      id: "a8-m14-l01-q2", role: "guided", kind: "numeric", difficulty: 3,
    ...
    {
      id: "a8-m14-l01-q3", role: "independent", kind: "numeric", difficulty: 3,
      question: "An arithmetic sequence has first term 6 and 12th term 61. What is the common difference?",
      answer: "5",
      hints: [
    ...
    {
      id: "a8-m14-l01-q4", role: "independent", kind: "numeric", difficulty: 3,
    ...
    {
      id: "a8-m14-l01-q5", role: "independent", kind: "mcq", difficulty: 2,
      question: "Which of the following sequences is arithmetic?",
      choices: ["$2, 4, 8, 16$", "$5, 8, 11, 14$", "$1, 4, 9, 16$", "$3, 6, 12, 24$"],
      answer: 1,
      hints: [
    ...
    {
      id: "a8-m14-l01-q6", role: "independent", kind: "numeric", difficulty: 5,
      question: "The sum of the first $n$ terms of an arithmetic sequence with first term 5 and common difference 3 is 185. Find $n$.",
      answer: "10",
      hints: [
  ...
  nextConnection: "Certain arithmetic sums, like consecutive integers, squares, and cubes, come up so often in contest problems that they earn their own standard formulas — the next lesson collects them.",
