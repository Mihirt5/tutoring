...
export default {
  ...
  sections: [
    {
      ...
      keyIdea: "Translate each sentence of a word problem into its own equation, reading comparison phrases in the exact order they appear.",
    },
    {
      id: "a8-m12-l03-s2",
      ...
      keyIdea: "Let the variable stand for whichever quantity the problem's conditions are phrased directly in terms of, so the other unknowns come out as fraction-free expressions.",
    },
    {
      id: "a8-m12-l03-s3",
      ...
      keyIdea: "Substitute the solved variable back into whatever expression the actual question refers to, and check that the final answer makes sense in the problem's real-world context.",
    },
  ],
  examples: [
    {
      ...
      problem: "Sam has 20 dollars more than Priya. Together they have 84 dollars. How much money does Sam have?",
      steps: [
      ...
      answer: "52",
      takeaway: "Solving for the chosen variable is not the last step whenever the question asks about a different quantity built from that variable.",
    },
    {
      id: "a8-m12-l03-ex2",
      title: "Choosing the total as the variable",
      problem: "A number of stamps is shared so that one friend receives 3 more than half of the total. That friend received 15 stamps. How many stamps were there in total?",
      steps: [
      ...
      answer: "24",
      takeaway: "Letting the variable match the quantity a condition is phrased in terms of avoids working backward through an extra fraction.",
    },
    {
      id: "a8-m12-l03-ex3",
      title: "Interpreting a whole-number answer in context",
      problem: "A store sells pens in packs of 4. Maria buys some packs and gives 6 pens to her friend, leaving her with 18 pens. How many packs did she buy?",
      steps: [
      ...
      answer: "6",
      takeaway: "Confirming that a final answer is a sensible whole number is a useful check that the equation was set up correctly.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      id: "a8-m12-l03-q1", role: "guided", kind: "numeric", difficulty: 3,
      question: "In 5 years, Maya will be twice as old as she was 3 years ago. How old is Maya now?",
      answer: "11",
      hints: [
    ...
    {
      id: "a8-m12-l03-q2", role: "guided", kind: "numeric", difficulty: 3,
      question: "A rectangular garden's length is 5 meters more than its width. If the perimeter is 34 meters, what is the width, in meters?",
      answer: "6",
      hints: [
    ...
    {
      id: "a8-m12-l03-q3", role: "independent", kind: "numeric", difficulty: 4,
      question: "A number of cookies is divided among some kids so each gets 4 less than a third of the total. Each kid received 6 cookies. How many cookies were there in total?",
      answer: "30",
      hints: [
    ...
    {
      id: "a8-m12-l03-q4", role: "independent", kind: "numeric", difficulty: 4,
      question: "A jar has red and blue marbles. There are 8 more blue marbles than red marbles, and together the marbles total 52. How many blue marbles are in the jar?",
      answer: "30",
      hints: [
    ...
    {
      id: "a8-m12-l03-q5", role: "independent", kind: "mcq", difficulty: 4,
      question: "A problem states: \"The number of adult tickets sold was 7 fewer than twice the number of child tickets sold, and 63 tickets were sold in total.\" Which choice of variable leads to equations without any fractions?",
      choices: ["Let $a$ = number of adult tickets; then $c=\\frac{a+7}{2}$", "Let $c$ = number of child tickets; then $a=2c-7$", "Let $x$ = half the total number of tickets", "Let $a$ = number of adult tickets; then $c=\\frac{a}{2}+7$"],
      answer: 1,
      hints: [
    ...
    {
      id: "a8-m12-l03-q6", role: "independent", kind: "numeric", difficulty: 5,
      question: "A number is increased by 6, and the result is tripled. This equals the number decreased by 4, then doubled, then increased by 50. Find the number.",
      answer: "24",
      hints: [
  ...
  nextConnection: "The next module applies this same word-problem discipline to a single, very common setup — distance equals speed times time — where choosing the right variable matters just as much.",
