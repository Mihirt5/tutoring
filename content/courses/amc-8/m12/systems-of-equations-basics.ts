...
export default {
  ...
  intro: "Many word problems describe two unknown quantities linked by two separate conditions. Writing one equation per condition produces a system of equations, and two standard methods — substitution and elimination — turn that system into a single equation in one variable, which can then be solved directly.",
  sections: [
    {
      id: "a8-m12-l01-s1",
      ...
      keyIdea: "Assign a variable to each unknown, then translate each separate condition into its own equation.",
    },
    {
      id: "a8-m12-l01-s2",
      ...
      keyIdea: "Isolate one variable in one equation, then replace it in the other equation to reduce the system to one variable.",
    },
    {
      id: "a8-m12-l01-s3",
      ...
      keyIdea: "Add or subtract the equations, scaling one or both first if needed, so that one variable's coefficients cancel.",
    },
  ],
  examples: [
    {
      ...
      problem: "The sum of two numbers is 15, and one number is twice the other. Find the larger number.",
      steps: [
      ...
      answer: "10",
      takeaway: "When one equation already isolates a variable in terms of the other, substitution reaches the answer in one replacement.",
    },
    {
      id: "a8-m12-l01-ex2",
      title: "Two numbers, solved by elimination",
      problem: "The sum of two numbers is 22, and their difference is 6. Find the smaller number.",
      steps: [
      ...
      answer: "8",
      takeaway: "Adding a sum equation and a difference equation for the same two quantities always cancels the smaller quantity directly.",
    },
    {
      id: "a8-m12-l01-ex3",
      title: "A ticket-pricing word problem",
      problem: "Adult tickets cost 8 dollars each and child tickets cost 5 dollars each. Ella bought 10 tickets in total for 65 dollars. How many child tickets did she buy?",
      steps: [
      ...
      answer: "5",
      takeaway: "A word problem with two quantities and two totals — a count and a cost — always translates into exactly one system of two equations.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      id: "a8-m12-l01-q1", role: "guided", kind: "numeric", difficulty: 3,
      question: "The sum of two numbers is 20, and one number is 4 more than the other. Find the larger number.",
      answer: "12",
      hints: [
    ...
    {
      id: "a8-m12-l01-q2", role: "guided", kind: "numeric", difficulty: 3,
      question: "A basketball costs $x$ dollars and a soccer ball costs $y$ dollars. Two basketballs and three soccer balls cost 76 dollars. Two basketballs and one soccer ball cost 52 dollars. What is the cost of one soccer ball, in dollars?",
      answer: "12",
      hints: [
    ...
    {
      id: "a8-m12-l01-q3", role: "independent", kind: "numeric", difficulty: 4,
      question: "Ravi is 3 years older than twice his sister's age. The sum of their ages is 30. How old is Ravi?",
      answer: "21",
      hints: [
    ...
    {
      id: "a8-m12-l01-q4", role: "independent", kind: "numeric", difficulty: 4,
      question: "A movie ticket costs $x$ dollars and a bag of popcorn costs $y$ dollars. Three movie tickets and two bags of popcorn cost 26 dollars. One movie ticket and one bag of popcorn cost 10 dollars. What is the cost of one movie ticket, in dollars?",
      answer: "6",
      hints: [
    ...
    {
      id: "a8-m12-l01-q5", role: "independent", kind: "mcq", difficulty: 4,
      question: "Which pair of equations can be solved by elimination in a single addition or subtraction step, without first multiplying either equation by a constant?",
      choices: ["$x+2y=7$ and $3x-y=5$", "$2x+3y=12$ and $2x-y=4$", "$x+y=5$ and $2x+3y=11$", "$3x+y=9$ and $x+2y=8$"],
      answer: 1,
      hints: [
    ...
    {
      id: "a8-m12-l01-q6", role: "independent", kind: "numeric", difficulty: 4,
      question: "The sum of two numbers is 50, and 3 times the smaller number equals the larger number minus 2. Find the smaller number.",
      answer: "12",
      hints: [
  ...
  nextConnection: "The next lesson extends these same tools to equations that need a clever substitution or an auxiliary variable before they fit this basic pattern.",
