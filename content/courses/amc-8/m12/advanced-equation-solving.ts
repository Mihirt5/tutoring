...
export default {
  ...
  intro: "Some equations resist the direct substitution-or-elimination approach from the previous lesson, but reveal a shortcut once a repeated expression is treated as its own quantity or once two equations are combined cleverly instead of solved variable by variable. This lesson builds the habit of looking for that shortcut, and of checking any answer against every condition in the original problem before trusting it.",
  sections: [
    {
      id: "a8-m12-l02-s1",
      ...
      keyIdea: "Before solving for every variable, check whether adding or subtracting the given equations directly produces the requested quantity.",
    },
    {
      id: "a8-m12-l02-s2",
      ...
      keyIdea: "Name a repeated or requested expression as its own variable, and solve for that expression directly instead of expanding it back into its parts.",
    },
    {
      id: "a8-m12-l02-s3",
      ...
      keyIdea: "After using a shortcut or identity, confirm the final answer satisfies every original condition in the problem, not just the combined equation used to find it.",
    },
  ],
  examples: [
    {
      ...
      answer: "5",
      takeaway: "When the requested quantity is a multiple of the sum of the two equations' left sides, add the equations directly instead of solving for each variable.",
    },
    {
      id: "a8-m12-l02-ex2",
      title: "An auxiliary variable for a repeated sum",
      problem: "Three times the sum of two numbers is 18 more than twice the sum of the same two numbers. Find the sum of the two numbers.",
      steps: [
      ...
      answer: "18",
      takeaway: "Naming a repeated expression with a single variable turns a wordy sentence into a one-step equation.",
    },
    {
      id: "a8-m12-l02-ex3",
      title: "Sum and product, verified against both conditions",
      problem: "Two positive numbers have a sum of 12 and a product of 35. Find the positive difference between the two numbers.",
      steps: [
      ...
      answer: "2",
      takeaway: "The identity $(x-y)^2=(x+y)^2-4xy$ finds a difference from a sum and a product without solving a quadratic, but the result should still be checked against both original conditions.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      id: "a8-m12-l02-q1", role: "guided", kind: "numeric", difficulty: 4,
    ...
    {
      id: "a8-m12-l02-q2", role: "guided", kind: "numeric", difficulty: 4,
      question: "Four times the sum of two numbers equals 21 more than the sum itself. Find the sum of the two numbers.",
      answer: "7",
      hints: [
    ...
    {
      id: "a8-m12-l02-q3", role: "independent", kind: "numeric", difficulty: 5,
      question: "Two positive numbers have a sum of 15 and a product of 44. Find the positive difference between the two numbers.",
      answer: "7",
      hints: [
    ...
    {
      id: "a8-m12-l02-q4", role: "independent", kind: "numeric", difficulty: 5,
    ...
    {
      id: "a8-m12-l02-q5", role: "independent", kind: "mcq", difficulty: 4,
      question: "A problem states that $3(x+y)-2=16$. What is the most efficient first step to find the value of $x+y$?",
      choices: ["Solve for $x$ first, then for $y$", "Let $s=x+y$ and solve $3s-2=16$ for $s$", "Guess and check integer values of $x$ and $y$", "Square both sides of the equation"],
      answer: 1,
      hints: [
    ...
    {
      id: "a8-m12-l02-q6", role: "independent", kind: "numeric", difficulty: 5,
      question: "Given $x+y=11$, $y+z=15$, and $x+z=14$, find the value of $x+y+z$.",
      answer: "20",
      hints: [
  ...
  nextConnection: "The next lesson applies these same techniques to full word problems, where the challenge shifts from manipulating given equations to first choosing which quantities to name as variables.",
