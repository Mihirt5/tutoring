...
export default {
  ...
  sections: [
    {
      ...
      keyIdea: "A sum of the form $\\sum_{k=1}^{n}(a_{k+1}-a_k)$ always collapses to $a_{n+1}-a_1$, since every middle value cancels.",
    },
    {
      id: "a8-m16-l01-s2",
      ...
      keyIdea: "Rewrite each term as $a_{k+1}-a_k$ for some recognizable family $a_k$ (such as squares) whose consecutive differences match the term.",
    },
    {
      id: "a8-m16-l01-s3",
      ...
      keyIdea: "Write out the first few and last few terms explicitly to confirm exactly which two pieces survive, especially when the index range is unusual.",
    },
  ],
  examples: [
    {
      ...
      answer: "5",
      takeaway: "Writing out a telescoping sum term by term makes the cancellation of every middle value visible.",
    },
    {
      id: "a8-m16-l01-ex2",
      title: "Summing odd numbers via squares",
      problem: "Find $1+3+5+7+9+11$ (the first six odd numbers) by rewriting each term as a difference of consecutive squares.",
      steps: [
      ...
      answer: "36",
      takeaway: "Recognizing $2k-1$ as a difference of consecutive squares turns a sum of odd numbers into a single subtraction.",
    },
    {
      id: "a8-m16-l01-ex3",
      title: "Confirming which pieces survive",
      problem: "Evaluate $\\big(f(1)-f(0)\\big)+\\big(f(2)-f(1)\\big)+\\big(f(3)-f(2)\\big)+\\cdots+\\big(f(10)-f(9)\\big)$, given that $f(0)=3$ and $f(10)=57$.",
      steps: [
      ...
      answer: "54",
      takeaway: "The individual values $f(1)$ through $f(9)$ never need to be known — only the first and last values matter.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      id: "a8-m16-l01-q1", role: "guided", kind: "numeric", difficulty: 2,
    ...
    {
      id: "a8-m16-l01-q2", role: "guided", kind: "numeric", difficulty: 3,
      question: "Find $1+3+5+7$ (the first four odd numbers) by rewriting each term as a difference of consecutive squares and cancelling.",
      answer: "16",
      hints: [
    ...
    {
      id: "a8-m16-l01-q3", role: "independent", kind: "numeric", difficulty: 3,
      question: "Evaluate $\\big(g(1)-g(0)\\big)+\\big(g(2)-g(1)\\big)+\\big(g(3)-g(2)\\big)+\\big(g(4)-g(3)\\big)+\\big(g(5)-g(4)\\big)$, given that $g(0)=7$ and $g(5)=42$.",
      answer: "35",
      hints: [
    ...
    {
      id: "a8-m16-l01-q4", role: "independent", kind: "numeric", difficulty: 4,
      question: "Find $1+3+5+7+9+11+13$ (the first seven odd numbers) using the difference-of-squares telescoping method.",
      answer: "49",
      hints: [
    ...
    {
      id: "a8-m16-l01-q5", role: "independent", kind: "mcq", difficulty: 3,
      question: "In a telescoping sum $\\sum_{k=1}^{n}(a_{k+1}-a_k)$, which terms remain after all cancellation?",
      choices: ["Every term remains; no cancellation occurs", "Only $a_{n+1}$ and $-a_1$ remain", "Only the middle terms remain", "The sum is always zero"],
      answer: 1,
      hints: [
    ...
    {
      id: "a8-m16-l01-q6", role: "independent", kind: "numeric", difficulty: 5,
      question: "Find $2+4+6+8+10+12$ (the first six positive even numbers) by rewriting the $k$th term $2k$ as $k(k+1)-(k-1)k$ and cancelling.",
      answer: "42",
      hints: [
  ...
  nextConnection: "The next lesson extends this same idea to sums involving fractions, using a partial-fraction-style split to reveal telescoping patterns that are not obvious at first glance.",
