...
export default {
  ...
  sections: [
    {
      ...
      keyIdea: "A product telescopes when each factor's numerator matches the denominator of a neighboring factor, leaving only the outermost numerator and denominator.",
    },
    {
      id: "a8-m16-l03-s2",
      ...
      keyIdea: "A factor like $1-\\frac{1}{k^2}$ splits via a difference of squares into $\\frac{k-1}{k}\\cdot\\frac{k+1}{k}$, producing two separate telescoping chains.",
    },
    {
      id: "a8-m16-l03-s3",
      ...
      keyIdea: "Track the surviving numerator and denominator for each chain separately, especially when a factor splits into two chains, and multiply the results together last.",
    },
  ],
  examples: [
    {
      ...
      problem: "Evaluate $\\dfrac{1}{2}\\cdot\\dfrac{2}{3}\\cdot\\dfrac{3}{4}\\cdot\\dfrac{4}{5}\\cdot\\dfrac{5}{6}$.",
      steps: [
      ...
      answer: "1/6",
      takeaway: "In a telescoping product $\\frac{a}{b}\\cdot\\frac{b}{c}\\cdot\\frac{c}{d}\\cdots$, every internal value cancels, leaving only the outermost numerator and denominator.",
    },
    {
      id: "a8-m16-l03-ex2",
      title: "A telescoping product running the other way",
      problem: "Evaluate $\\dfrac{2}{1}\\cdot\\dfrac{3}{2}\\cdot\\dfrac{4}{3}\\cdot\\dfrac{5}{4}\\cdot\\dfrac{6}{5}$.",
      steps: [
      ...
      answer: "6",
      takeaway: "The same cancellation pattern works whether the fractions increase or decrease through the product.",
    },
    {
      id: "a8-m16-l03-ex3",
      title: "Splitting a factor with a difference of squares",
      problem: "Evaluate $\\left(1-\\dfrac{1}{2^2}\\right)\\left(1-\\dfrac{1}{3^2}\\right)\\left(1-\\dfrac{1}{4^2}\\right)\\left(1-\\dfrac{1}{5^2}\\right)$.",
      steps: [
      ...
      answer: "3/5",
      takeaway: "Splitting one factor into two chains, and evaluating each chain's own telescoping separately, handles products that are not already in ready-to-cancel form.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    {
      id: "a8-m16-l03-q1", role: "guided", kind: "numeric", difficulty: 3,
      question: "Evaluate $\\dfrac{2}{3}\\cdot\\dfrac{3}{4}\\cdot\\dfrac{4}{5}\\cdot\\dfrac{5}{6}$.",
      answer: "1/3",
      hints: [
    ...
    {
      id: "a8-m16-l03-q2", role: "guided", kind: "numeric", difficulty: 3,
      question: "Evaluate $\\dfrac{3}{2}\\cdot\\dfrac{4}{3}\\cdot\\dfrac{5}{4}\\cdot\\dfrac{6}{5}\\cdot\\dfrac{7}{6}$.",
      answer: "7/2",
      hints: [
    ...
    {
      id: "a8-m16-l03-q3", role: "independent", kind: "numeric", difficulty: 4,
      question: "Evaluate $\\dfrac{1}{2}\\cdot\\dfrac{2}{3}\\cdot\\dfrac{3}{4}\\cdots\\dfrac{9}{10}$.",
      answer: "1/10",
      hints: [
    ...
    {
      id: "a8-m16-l03-q4", role: "independent", kind: "numeric", difficulty: 6,
      question: "Evaluate $\\left(1-\\dfrac{1}{3^2}\\right)\\left(1-\\dfrac{1}{4^2}\\right)\\left(1-\\dfrac{1}{5^2}\\right)\\left(1-\\dfrac{1}{6^2}\\right)$.",
      answer: "7/9",
      hints: [
    ...
    {
      id: "a8-m16-l03-q5", role: "independent", kind: "mcq", difficulty: 4,
      question: "Which rewriting best exposes the telescoping structure hidden inside the factor $1-\\dfrac{1}{k^2}$?",
      choices: ["$k\\cdot k$", "$\\dfrac{k-1}{k}\\cdot\\dfrac{k+1}{k}$", "$k^2-1$, left unfactored", "$(k-1)+(k+1)$"],
      answer: 1,
      hints: [
    ...
    {
      id: "a8-m16-l03-q6", role: "independent", kind: "numeric", difficulty: 5,
      question: "For which value of $n$ does $\\dfrac{1}{2}\\cdot\\dfrac{2}{3}\\cdot\\dfrac{3}{4}\\cdots\\dfrac{n}{n+1}=\\dfrac{1}{12}$?",
      answer: "11",
      hints: [
  ...
  nextConnection: "The final lesson in this module puts telescoping to work inside an equation that must first be simplified before it can be solved.",
