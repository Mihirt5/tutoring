...
export default {
  ...
  sections: [
    {
      ...
      keyIdea:
        "$\\dfrac{1}{k(k+d)}=\\dfrac{1}{d}\\left(\\dfrac{1}{k}-\\dfrac{1}{k+d}\\right)$; for $d=1$, this is simply $\\dfrac{1}{k}-\\dfrac{1}{k+1}$.",
    },
    {
      id: "a8-m16-l02-s2",
      ...
      keyIdea:
        "After splitting, $\\sum_{k=a}^{b}\\frac{1}{k(k+1)}$ telescopes to $\\frac{1}{a}-\\frac{1}{b+1}$, keeping only the first and last surviving fractions.",
    },
    {
      id: "a8-m16-l02-s3",
      ...
      keyIdea:
        "When the split skips by $d>1$, exactly $d$ fractions survive at the start and $d$ at the end, not just one on each side.",
    },
  ],
  examples: [
    {
      ...
      answer: "5/6",
      takeaway:
        "Splitting each term before summing turns a sum of five fractions into a single subtraction.",
    },
    {
      id: "a8-m16-l02-ex2",
      ...
      answer: "2/9",
      takeaway:
        "A sum that starts above $k=1$ still telescopes; only the identity of the surviving first and last fractions changes.",
    },
    {
      id: "a8-m16-l02-ex3",
      ...
      answer: "69/112",
      takeaway:
        "With a denominator gap of 2, two fractions survive at each end of the sum, not just one.",
    },
  ],
  commonMistakes: [
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      question:
        "Which identity correctly splits $\\dfrac{1}{k(k+3)}$ for a telescoping sum?",
      choices: [
        "$\\dfrac{1}{k}-\\dfrac{1}{k+3}$",
        "$\\dfrac{1}{3}\\left(\\dfrac{1}{k}-\\dfrac{1}{k+3}\\right)$",
        "$\\dfrac{1}{3}\\left(\\dfrac{1}{k}+\\dfrac{1}{k+3}\\right)$",
        "$\\dfrac{1}{k+3}-\\dfrac{1}{k}$",
      ],
      answer: 1,
      hints: [
  ...
  nextConnection:
    "The same splitting idea works on products instead of sums — the next lesson develops telescoping products, where factors cancel instead of terms subtracting away.",
